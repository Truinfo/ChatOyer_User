...
const Description = ({ addToCart, addToWishlist, addToOrder }) => {
  ...
  const handleSizeChange = (size, index) => {
    ...
    const sizePrice = index * 5000; // Adjusted for starting from 0 and increasing by 2500
  ...
  const hasCustomizationDetails =
    selectedSize || selectedDiamondType || selectedGoldKt;
    ...
    <div className="description">
      <div>
        <div className="details" key={product._id}>
          ...
          <div className="big-img">
            {isVideoPlaying ? (
              ...
              >
                <source
                  src={`http://localhost:2000${product.videoProduct}`}
                  type="video/mp4"
                />
          ...
          <div className="box1">
            ...
            <div className="thumb">
              <video
                width={100}
                className={selectedThumbnail === null ? "active" : ""}
                controls // Add controls to allow the user to play/pause the video
                ...
                <>
                  <div className="row d-flex">
                    ...
                    <div className="col-md-3 cutomize-goldtype">
                      ...
                      >
                        {product.goldType &&
                          product.goldType.map((type, index) => (
                    ...
                    {/* GoldKt */}
                    <div className="col-md-9 customize-goldkt  ">
                      <AiFillGold /> GOLD KARAT :
                      {product.goldKt &&
                        product.goldKt.map((karat, index) => (
                  ...
                  {product.diamondType && product.diamondType.length > 0 && (
                    <div className="customize-diamond">
                      ...
                      {product.diamondType.map((type, index) => (
                        <label key={index} className="radio-inline">
                          <input
                            type="radio"
                            name="diamondKarat"
          ...
          <Carousel responsive={responsive}>
            {similarProducts.map((item) => (
              <div className="Similar-products-card">
                ...
                <h2>{item.name}</h2>
                <p className="Pprice fs-2">₹ {item.total}/-</p>
              </div>
            ))}
          </Carousel>
        </div>
        <div className="product-details-container m-4">
          <table
            className="product-details-table fs-4"
            style={{
            ...
            <tbody>
              ...
              {product.goldType && (
                <tr>
                  ...
                  <td className="col-md-6">{product.goldType}</td>
                </tr>
              )}
              {product.goldKt && (
                <tr>
                  ...
                  <td className="col-md-6">
                    {product.goldKt && product.goldKt.length > 0
                      ? product.goldKt.join(", ")
                      : ""}
                  </td>
                </tr>
              ...
              {product.goldWeight && (
                <tr>
                  <td className="col-md-6">Weight</td>
                  <td className="col-md-6">{product.goldWeight}</td>
                </tr>
              )}
              ...
              {hasCustomizationDetails && (
                <>
                  <tr>
                    <th colSpan="2">CUSTOMIZED DETAILS</th>
                  </tr>
                  {selectedSize && (
                    <>
                      <tr>
